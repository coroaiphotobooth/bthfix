...
const AdminPage: React.FC<AdminPageProps> = ({ settings, concepts, onSaveSettings, onSaveConcepts, onBack, onLaunchMonitor }) => {
  ...
  useEffect(() => {
    setLocalSettings(prev => {
      ...
      if (merged.enableVideoGeneration === undefined) merged.enableVideoGeneration = true;
      ...
      <div className="max-w-7xl mx-auto w-full pb-24">
        ...
        <div className="flex justify-end mb-8">
           <button 
             ...
             className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-900 to-purple-900 border border-blue-500/30 hover:border-blue-400 text-blue-200 font-heading tracking-[0.2em] uppercase rounded-lg shadow-lg hover:shadow-blue-500/20 transition-all"
           >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="glass-card p-6 md:p-10 flex flex-col gap-8 h-fit">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <input 
                    className="bg-black/50 border border-white/10 p-4 font-mono text-xs text-purple-300 focus:border-purple-500 outline-none transition-colors" 
                 ...
                 {/* DATABASE CONNECTION */}
                 <div className="bg-purple-900/10 border border-purple-500/20 p-4 rounded-lg flex flex-col gap-3">
                  <div className="flex justify-between items-center">
                    <label className="text-[10px] text-purple-400 uppercase tracking-widest font-bold">Google Sheet ID (Database)</label>
                    <a 
                      href={`https://docs.google.com/spreadsheets/d/${localSettings.spreadsheetId || settings.spreadsheetId}/edit`} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-[9px] underline text-white/50 hover:text-white"
                    >
                      OPEN DATABASE
                    </a>
                  </div>
                  ...
                  <p className="text-[9px] text-gray-500">
                    * If blank, system creates a new sheet automatically. Paste ID to link existing sheet.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      <span className="text-sm font-bold">MODEL 2.5</span>
                    ...
                    >
                      <span className="text-sm font-bold">MODEL 3</span>
                ...
                {/* Video Settings */}
                <h3 className="font-heading text-xl text-purple-400 border-b border-white/5 pb-4 mt-6 uppercase italic">Video Generation (Veo)</h3>
                
                {/* Video Toggle */}
                <div className="flex items-center justify-between bg-white/5 p-4 rounded border border-white/10">
                  <label className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Enable "Generate Video" Button</label>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                      className="w-5 h-5 accent-purple-600 cursor-pointer"
                      checked={localSettings.enableVideoGeneration ?? true}
                      onChange={e => setLocalSettings({...localSettings, enableVideoGeneration: e.target.checked})}
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <textarea 
                    className="bg-black/50 border border-white/10 p-4 font-mono text-xs text-white focus:border-purple-500 outline-none transition-colors h-24" 
                ...
                <div className="flex flex-col gap-3">
                  <label className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Image Card Size</label>
                  <div className="grid grid-cols-3 gap-3">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <input 
                    type="text"
                    maxLength={8}
                    className="bg-red-900/10 border border-red-500/30 p-4 font-mono text-xs text-red-200 focus:border-red-500 outline-none transition-colors tracking-[0.5em] text-center" 
                ...
                <button onClick={handleSaveSettings} className="w-full py-6 bg-green-800 hover:bg-green-700 text-white font-heading tracking-widest uppercase italic mt-6 transition-all">SAVE SETTINGS & LINK DB</button>
              </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="glass-card p-6 md:p-10 flex flex-col gap-8 border-white/10 h-fit text-center">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <button onClick={() => overlayInputRef.current?.click()} disabled={isUploadingOverlay} className="w-full py-4 border-2 border-white/10 hover:border-purple-500 text-[10px] tracking-widest font-bold uppercase bg-white/5">
                ...
                {/* Background Asset */}
                <div className="glass-card p-6 md:p-10 flex flex-col gap-8 border-white/10 h-fit text-center">
                  <h3 className="font-heading text-xl text-purple-400 border-b border-white/5 pb-4 uppercase italic">Menu Background</h3>
                  <div className="flex flex-col gap-6">
                    ...
                    <button onClick={() => backgroundInputRef.current?.click()} disabled={isUploadingBackground} className="w-full py-4 border-2 border-white/10 hover:border-purple-500 text-[10px] tracking-widest font-bold uppercase bg-white/5">
                ...
                <div className="glass-card p-6 md:p-10 flex flex-col gap-8 border-white/10 h-fit text-center">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <button onClick={() => audioInputRef.current?.click()} disabled={isUploadingAudio} className="w-full py-4 border-2 border-white/10 hover:border-purple-500 text-[10px] tracking-widest font-bold uppercase bg-white/5">
        ...
        {activeTab === 'concepts' && (
          <div className="flex flex-col gap-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <button onClick={handleAddConcept} className="glass-card p-6 flex flex-col items-center justify-center gap-4 border-2 border-dashed border-white/10 hover:border-purple-500/50 hover:bg-white/5 transition-all min-h-[200px]">
            ...
            <div className="flex justify-center mt-10">
              <button onClick={handleSyncConcepts} disabled={isSavingConcepts} className="px-20 py-6 bg-purple-600 font-heading tracking-widest uppercase italic shadow-2xl hover:bg-purple-500 transition-all disabled:opacity-50">
